...
private:
  ...
  void paintBrakePBClutchStatus(QPainter &p, const cereal::CarState::Reader &carState, const QJsonObject &frogpilot_toggles);
  void paintRPMeter(QPainter &p, const cereal::CarState::Reader &carState);
  void updateSignals();
