...
private:
  ...
  QSet<QString> deviceManagementKeys = {"AutomaticBackup", "DeviceShutdown", "HigherBitrate", "IncreaseThermalLimits", "LowVoltageShutdown", "NoLogging", "NoUploads", "UseKonikServer"};
