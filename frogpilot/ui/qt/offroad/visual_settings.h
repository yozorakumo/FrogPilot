...
private:
  ...
  QSet<QString> advancedCustomOnroadUIKeys = {"AlertDismissSeconds", "HideAlerts", "HideLeadMarker", "HideMapIcon", "HideMaxSpeed", "HideSpeed", "HideSpeedLimit", "WheelSpeed"};
  QSet<QString> customOnroadUIKeys = {"AccelerationPath", "AdjacentPath", "BlindSpotPath", "BrakePBClutchUI", "Compass", "OnroadDistanceButton", "PedalsOnUI", "RotatingWheel"};
