...
private:
  ...
  QSet<QString> mazdaKeys = {"MazdaAutoLock", "MazdaAutoUnlock", "MazdaBrakeUI", "MazdaClutchUI", "MazdaLockSpeed", "MazdaMTMode", "MazdaMTUI", "MazdaPBUI", "MazdaRPMeter", "MazdaUnlockSpeed", "SpeedometerStyle"};
