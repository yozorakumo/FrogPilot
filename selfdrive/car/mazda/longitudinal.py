...
# Mazda 2 DJ MT uses its own DBC with CRZ_INFO/CRZ_CTRL definitions
MAZDA_LONG_DBC = DBC("mazda_2_dj_mt")
...
def create_longitudinal_messages(bus, accel, counter, long_active, lead_visible, *,
                                 ...
                                 crz_info_resume_unlatching=False, v_ego=0.0) -> list[CanData]:
...
def create_radar_tester_present(bus=RADAR_BUS) -> CanData:
